...
class VueTailwindStackInstaller
{
    ...
    public function run()
    {
        ...
        try {
            ...
            $this->output->writeln("<info>Installing Vue.js...</info>");
            $this->runShellCommand("cd {$projectPath} && npm install vue@next vue-router");
            ...
            $this->output->writeln("<info>✓ Vue.js + Tailwind CSS stack setup completed!</info>");
            return true;
        } catch (\Exception $e) {
