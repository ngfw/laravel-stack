...
class LivewireTailwindStackInstaller
{
    ...
    public function run()
    {
        $this->output->writeln("<info>Setting up Livewire + Tailwind CSS stack for '{$this->projectName}'...</info>");
        ...
        try {
            ...
            $this->output->writeln("<info>Installing Livewire...</info>");
            $this->runShellCommand("cd {$projectPath} && composer require livewire/livewire");
            ...
            $this->output->writeln("<info>✓ Livewire + Tailwind CSS stack setup completed!</info>");
            return true;
        } catch (\Exception $e) {
